...
Conditional probabilities of glucose excretion level is >=60 mg/d or <60 mg/d given a high or low exposure
Conditional probabilities of creatinine excretion level is >=60 mg/d or <60 mg/d given a high or low exposure
...
Continuous variables cannot be in a binomal or Poisson as it is not a success/failure outcome.
...
creatinine_normal <- rnorm(50, 9.712, 3.415)
creatinine_normal <- data.frame(creatinine_normal)
...
histo_creat_norm <- ggplot(creatinine_normal, aes(creatinine_normal))+
  geom_histogram(binwidth = 1) +
  theme_minimal(base_size = 15)
histo_creat_norm_small
# fill this in

histo_creat_norm_big
# fill this in
